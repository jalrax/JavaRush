...
{
    //    private static final String URL_FORMAT = "https://moikrug.ru/vacancies?&city_id=726&currency=rur&page=%d&q=" + a + "+%s";
    private static final String URL_FORMAT = "www.rabota.yandex.ru/search?text=java&rid=39&page_num=%d";
        ...
        try
        {
            ...
            while (true)
            {
                ...
                for (Element element : elements)
                {
                    ...
                    // url
                    String url = "https://rabota.yandex.ru" + titleElement.getElementsByTag("a").attr("href");
                    ...
                    // site
                    String siteName = "https://rabota.yandex.ru/";
